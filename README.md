...
- [`cli/`](cli/) — the `aifootprint` command-line client: a thin wrapper around the Python SDK for terminals, shell scripts, and CI/CD. See its own `README.md` for a Quick Start.
